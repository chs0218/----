...
void MoveCar(Car car[4], int n, BOOL GO[4], int order[], int* ordernum, BOOL Sign[3])
{
	...
	case 1:
		if (GO[0])
		{
			...
			if (IntersectRect(&rctmp, &car[0].rect, &car[1].rect))
			{
				car[0].rect.top -= 10;
				car[0].rect.bottom -= 10;
				break;
			...
			if (IntersectRect(&rctmp, &car[0].rect, &car[3].rect))
			{
				car[0].rect.top -= 10;
				car[0].rect.bottom -= 10;
				break;
	...
	case 2:
		if (GO[1])
		{
			...
			if (IntersectRect(&rctmp, &car[1].rect, &car[2].rect))
			{
				car[1].rect.left += 10;
				car[1].rect.right += 10;
				break;
			...
			if (IntersectRect(&rctmp, &car[1].rect, &car[0].rect))
			{
				car[1].rect.left += 10;
				car[1].rect.right += 10;
				break;
	...
	case 3:
		if (GO[2])
		{
			...
			if (IntersectRect(&rctmp, &car[2].rect, &car[3].rect))
			{
				car[2].rect.top += 10;
				car[2].rect.bottom += 10;
				break;
			...
			if (IntersectRect(&rctmp, &car[2].rect, &car[1].rect))
			{
				car[2].rect.top += 10;
				car[2].rect.bottom += 10;
				break;
	...
	case 4:
		if (GO[3])
		{
			...
			if (IntersectRect(&rctmp, &car[3].rect, &car[0].rect))
			{
				car[3].rect.left -= 10;
				car[3].rect.right -= 10;
				break;
			...
			if (IntersectRect(&rctmp, &car[3].rect, &car[2].rect))
			{
				car[3].rect.left -= 10;
				car[3].rect.right -= 10;
				break;
