...
void MaxLDiagStone(int Board[20][20])
{
	...
	while (StartX < 20)
	{
		...
		if (MaxBlack != 0 || MaxWhite != 0)
		{
			if (MaxBlack > MaxWhite)
			{
				std::cout << StartX + 1 << "번째 왼쪽 아래 대각선줄의 연속된 흑돌 개수: " << MaxBlack;
				std::cout << " 흑돌 좌표: ";
				for (int i = MaxBlack; i > 0; --i)
				{
					std::cout << "(" << BlackLocation[0] + i << ", " << BlackLocation[1] - i << ")";
			...
			{
				std::cout << StartX + 1 << "번째 왼쪽 아래 대각선줄의 연속된 백돌 개수: " << MaxWhite;
				std::cout << " 백돌 좌표: ";
				for (int i = MaxWhite; i > 0; --i)
				{
					std::cout << "(" << WhiteLocation[0] + i << ", " << WhiteLocation[1] - i << ")";
...
void MaxLDiagStone2(int Board[20][20])
{
	...
	while (StartY < 20)
	{
		...
		if (MaxBlack != 0 || MaxWhite != 0)
		{
			if (MaxBlack > MaxWhite)
			{
				std::cout << 20 + StartY << "번째 왼쪽 아래 대각선줄의 연속된 흑돌 개수: " << MaxBlack;
				std::cout << " 흑돌 좌표: ";
				for (int i = MaxBlack; i > 0; --i)
				{
					std::cout << "(" << BlackLocation[0] + i << ", " << BlackLocation[1] - i << ")";
			...
			{
				std::cout << 20 + StartY << "번째 왼쪽 아래 대각선줄의 연속된 백돌 개수: " << MaxWhite;
				std::cout << " 백돌 좌표: ";
				for (int i = MaxWhite; i > 0; --i)
				{
					std::cout << "(" << WhiteLocation[0] + i << ", " << WhiteLocation[1] - i << ")";
