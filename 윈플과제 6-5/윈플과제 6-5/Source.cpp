	...
	case WM_COMMAND:
		...
		case IDC_BUTTON3:
			...
			if (Gender)
			{
				...
				{
				case 0:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 여자, 출생년도: 1970", name, CallNumber);
					break;
				case 1:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 여자, 출생년도: 1980", name, CallNumber);
					break;
				case 2:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 여자, 출생년도: 1990", name, CallNumber);
					break;
				case 3:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 여자, 출생년도: 2000", name, CallNumber);
					break;
				case 4:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 여자, 출생년도: 2010", name, CallNumber);
					break;
				}
			}
			else
			{
				...
				{
				case 0:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 남자, 출생년도: 1970", name, CallNumber);
					break;
				case 1:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 남자, 출생년도: 1980", name, CallNumber);
					break;
				case 2:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 남자, 출생년도: 1990", name, CallNumber);
					break;
				case 3:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 남자, 출생년도: 2000", name, CallNumber);
					break;
				case 4:
					wsprintf(output, "이름: %s, 전화번호: %s, 성별: 남자, 출생년도: 2010", name, CallNumber);
					break;
				}
			}
